...
from test_design import degrees_list
...
def paraller_fluent(start_idx, end_idx):
 for i in range(start_idx, end_idx):
    ...
    # 后处理
    solver.tui.file.export.ascii('work/data_temp/tps' + str(data[i, 0]) + '.txt', (), 'yes', 'temperature', 'q', 'yes')

    # solver.tui.solve.dual_time_iterate('dual_time_iterate', '100', '20')
    solver.tui.file.write_case_data(('work/tps/tps' + str(data[i, 0]) + '.cas'))
